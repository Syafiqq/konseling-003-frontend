  ...
  <div class="landing-page">
    ...
    <nav class="navbar navbar-light bg-light static-top">
      <div class="container">
        ...
        <router-link :to="{ name: 'auth-login'}" class="btn btn-primary" href="javascript:void(0)">Sign In</router-link>
      </div>
    </nav>
    ...
    <section class="showcase">
      <div class="container-fluid p-0">
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 order-lg-2 text-white showcase-img showcase-1"></div>
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 text-white showcase-img showcase-2"></div>
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 order-lg-2 text-white showcase-img showcase-3"></div>
          <div class="col-lg-6 order-lg-1 my-auto showcase-text">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              <img class="img-fluid rounded-circle mb-3" src="../assets/img/landing-page/testimonials-1.jpg" alt="">
              <h5>Margaret E.</h5>
          ...
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              <img class="img-fluid rounded-circle mb-3" src="../assets/img/landing-page/testimonials-2.jpg" alt="">
              <h5>Fred S.</h5>
          ...
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              <img class="img-fluid rounded-circle mb-3" src="../assets/img/landing-page/testimonials-3.jpg" alt="">
              <h5>Sarah W.</h5>
